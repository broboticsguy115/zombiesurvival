...
function ENT:Use(activator, caller)
	...
	elseif ishuman and not pl.ArsenalBan then
		activator:CenterNotify(COLOR_RED, translate.ClientGet(activator, "you_cant_purchase_now"))
	elseif ishuman and pl.ArsenalBan then
		activator:CenterNotify(COLOR_RED, translate.ClientGet(activator, "banned_for_life_warning"))
	end
end
