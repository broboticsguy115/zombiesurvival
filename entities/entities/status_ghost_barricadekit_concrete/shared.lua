...
ENT.Model = Model("models/props_c17/concrete_barrier001a.mdl")

ENT.GhostModel = Model("models/props_c17/concrete_barrier001a.mdl")
ENT.GhostRotation = Angle(270, 0, 0)
ENT.GhostHitNormalOffset = 0
ENT.GhostEntity = "prop_aegisconcrete"
ENT.GhostWeapon = "weapon_zs_barricadekit"
ENT.GhostDistance = 100
...
function ENT:RecalculateValidity()
	...
	local entity
	local tr = util.TraceLine({start = shootpos, endpos = shootpos + owner:GetAimVector() * 100, mask = MASK_SOLID_BRUSHONLY, filter = owner})
