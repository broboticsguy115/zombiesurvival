...
LANGUAGE.humans_win									= "Mennesker vinder!"
...
LANGUAGE.banned_for_life_warning					= "Du er forbudt for livet."
...
LANGUAGE.cant_remove_nails_of_superior_player		= "Kan ikke fjerne søm fra en spiller på højere niveau."
...
LANGUAGE.press_f2_for_the_points_shop				= "Tryk på %q for Point Butik!"
...
LANGUAGE.number_of_initial_zombies_this_game		= "Hold dig væk fra zombie gyder!"
LANGUAGE.humans_closest_to_spawns_are_zombies		= "Menneskerne tættest på zombiernes gravsted vil starte som zombier."
LANGUAGE.hint_starting_gear						    = "Tryk på %q for at købe startudstyr"
LANGUAGE.round_begins                               = "Runden begynder om"
