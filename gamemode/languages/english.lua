...
LANGUAGE.humans_win									= "Humans win!"
...
LANGUAGE.banned_for_life_warning					= "You are Banned for Life." --You are banned for life.
...
LANGUAGE.cant_remove_nails_of_superior_player		= "Can't remove nail of higher leveled player."
...
LANGUAGE.press_f2_for_the_points_shop				= "Press %q for the Points Shop!"
...
LANGUAGE.number_of_initial_zombies_this_game		= "Stay away from zombie spawns!"
LANGUAGE.humans_closest_to_spawns_are_zombies		= "The humans closest to the zombie spawns will start as zombies."
LANGUAGE.hint_starting_gear						    = "Press %q to buy starting gear"
LANGUAGE.round_begins                               = "Round begins in"
...
<li>You can create, save, load, delete, and mark as default carts by pressing %q. This saves a ton of time which could be better spent setting up barricades or creating game plans.</li>
