...
LANGUAGE.humans_win									= "¡Los humanos ganan!"
...
LANGUAGE.banned_for_life_warning = "Estás prohibido de por vida."
...
LANGUAGE.cant_remove_nails_of_superior_player = "No se puede quitar la uña de un jugador de nivel superior."
...
LANGUAGE.press_f2_for_the_points_shop = "Pulsa %q para la Tienda de Puntos!"
...
LANGUAGE.number_of_initial_zombies_this_game = "¡Manténgase alejado de los engendros de zombis!"
LANGUAGE.humans_closest_to_spawns_are_zombies		= "Los seres humanos más cercanos al engendro de zombies serán seleccionados."
LANGUAGE.hint_starting_gear						    = "Presione %q para comprar marcha inicial"
LANGUAGE.round_begins                               = "La ronda comienza en"
