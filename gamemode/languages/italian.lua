...
translate.AddLanguage("it", "Italian")
    ...
    LANGUAGE.humans_win														= "Gli umani vincono!"                                                                     
    ...
    LANGUAGE.banned_for_life_warning                                        = "Sei bandito a vita."
    ...
    LANGUAGE.cant_remove_nails_of_superior_player                           = "Non è possibile rimuovere l'unghia del giocatore di livello superiore."
    ...
    LANGUAGE.press_f2_for_the_points_shop                                   = "Premi %q per visualizzare lo Points Shop!"
    ...
    LANGUAGE.number_of_initial_zombies_this_game                            = "Stai lontano dagli spawn degli zombi!"
    LANGUAGE.humans_closest_to_spawns_are_zombies                           = "Gli umani più vicini alla base degli zombie inizieranno come zombie."
	LANGUAGE.hint_starting_gear						    = "Premi %q per acquistare l'attrezzatura iniziale"
	LANGUAGE.round_begins                               = "Il round inizia tra"  
