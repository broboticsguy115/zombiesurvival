...
LANGUAGE.banned_for_life_warning					= "당신은 평생 금지되어 있습니다."
...
LANGUAGE.cant_remove_nails_of_superior_player		= "레벨이 높은 플레이어의 못을 제거 할 수 없습니다."
...
LANGUAGE.press_f2_for_the_points_shop				= "%q를 눌러 상점 사용!"
LANGUAGE.breath										= "O2"
LANGUAGE.zombie_volunteers							= "좀비 지원자 목록"
LANGUAGE.x_discount_for_buying_between_waves		= "웨이브 사이엔 %d 할인된 가격으로 판매한다!"
LANGUAGE.number_of_initial_zombies_this_game		= "좀비 스폰을 피하세요!"
LANGUAGE.humans_closest_to_spawns_are_zombies		= "좀비 스폰 지역에 가까운 인간이 좀비가 된다."
LANGUAGE.hint_starting_gear						    = "시작 장비를 구입하려면 %q를 누르십시오."
LANGUAGE.round_begins                               = "라운드 시작"
...
<li>%q를 눌러 장바구니를 만들거나, 저장하거나, 불러오거나, 삭제하거나, 기본 장바구니로 설정할 수 있다. 이렇게 장바구니로 등록한 후 구매하면 엄청나게 많은 시간을 절약하여 전략을 짤 수 있다.</li>
