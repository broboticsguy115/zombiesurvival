...
LANGUAGE.humans_win									= "Люди побеждают!"
...
LANGUAGE.banned_for_life_warning					= "Вы забанены пожизненно."
...
LANGUAGE.cant_remove_nails_of_superior_player		= "Невозможно удалить гвоздь игрока более высокого уровня."
...
LANGUAGE.press_f2_for_the_points_shop				= "Нажмите %q чтобы открыть Points Shop!"
...
LANGUAGE.number_of_initial_zombies_this_game		= "Держитесь подальше от появления зомби!"
LANGUAGE.humans_closest_to_spawns_are_zombies		= "Самые близко стоящие к спауну зараженних станут зараженными."
LANGUAGE.hint_starting_gear						    = "Нажмите %q, чтобы купить стартовую передачу"
LANGUAGE.round_begins                               = "Раунд начинается в"
...
<li>Мы можете создавать, сохранять, загружать, удалять и помечать, как стандартные покупки, нажимая %q. Таким образом вы можете сохранить тонны времени на баррикадирование или обдумывание планов на игру.</li>
