...
GM.StartLoadouts = {
	{"blstr", "3sgcp", "2sgcp", "zpplnk", "stone"},
	{"btlax", "3pcp", "2pcp", "zpaxe"},
	{"stbbr", "3rcp", "2rcp", "zpfryp"},
	{"tossr", "3smgcp", "2smgcp", "zpplnk", "grenade"},
	{"z9000", "3pls", "stnbtn", "resupplybox", "stone"},
	{"owens", "3pcp", "2pcp", "csknf", "stone", "5spd", "10spd"},
	{"tossr", "medkit", "2smgcp"},
	{"crklr", "3arcp", "2arcp", "stone", "zpcpot"},
	{"btlax", "3pcp", "2pcp", "arscrate", "stone"},
	{"crphmr", "pshtr", "2pcp", "bfhandy"}
}
...
GM.OutnumberedHealthBonus = CreateConVar("zs_outnumberedhealthbonus", "2", FCVAR_ARCHIVE + FCVAR_NOTIFY, "Give zombies some extra maximum health if there are less than or equal to this many zombies. 0 to disable."):GetInt()
