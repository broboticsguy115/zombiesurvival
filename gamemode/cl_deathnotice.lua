...
killicon.AddFont("weapon_zs_barreler", "zsdeathnotice", "-")
...
killicon.Add("weapon_zs_laserpistol", "zombiesurvival/killicons/weapon_zs_novacolt2")
...
killicon.Add("weapon_zs_t_oxygentank", "zombiesurvival/killicons/weapon_zs_oxygentank")
